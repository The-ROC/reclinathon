...
class MOVIE extends RTT_COMMON
{
    ...
    {
        echo "<TABLE>";
        echo "<TR cellspacing='0'><TH><A HREF = 'insert.php?MovieID=" . $this->MovieID . "'>" . $this->Title . "</A></TH><TH CLASS='right'>" . $this->Freshness . "% fresh <INPUT TYPE='checkbox' NAME='vote" . $this->MovieID . "' VALUE='movie" . $this->MovieID . "' onclick='ToggleDisplay(this)'></TH></TR>";
        ...
        echo "<BR><BR><BR><A HREF='" . $this->IMDBLink . "'>IMDB</A><BR><A HREF = '" . $this->TrailerLink . "'>Trailer</A></TD></TR>";
        echo "</TABLE>";
    }
    ...
    public function DisplayForm()
    {
        ...
        echo"<TR><TD> </TD><TD><INPUT TYPE='hidden' NAME='class' VALUE='MOVIE'><INPUT TYPE='hidden' NAME='MovieID' VALUE='" . $this->MovieID . "'><INPUT  TYPE='submit' VALUE='Submit'></TD></TR>";
        echo "</TABLE>";
        echo "</FORM>";
    }
