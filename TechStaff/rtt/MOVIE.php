...
class MOVIE extends RTT_COMMON
{
    ...
    {
        echo "<TABLE>";
        echo "<TR cellspacing='0'><TH><A HREF = 'insert.php?class=MOVIE&ObjectID=" . $this->MovieID . "'>" . $this->Title . "</A></TH><TH CLASS='right'>" . $this->Freshness . "% fresh <INPUT TYPE='checkbox' NAME='vote" . $this->MovieID . "' VALUE='movie" . $this->MovieID . "' onclick='ToggleDisplay(this)'></TH></TR>";
