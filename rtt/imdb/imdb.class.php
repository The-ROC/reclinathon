<?php
 ...
 /* $Id: imdb.class.php 278 2009-11-25 20:50:07Z izzy $ */
  ...
  * @version $Revision: 278 $ $Date: 2009-11-25 21:50:07 +0100 (Mi, 25. Nov 2009) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function imdb ($id) {
   $this->imdb_base($id);
   $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 278 $');
  }
