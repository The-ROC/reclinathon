...
class MOVIE extends RTT_COMMON
{
	...
	public function DisplaySpecialElection()
    {
		...
		if (count($ThemeMovies) > 0)
		{
			...
			echo "You know that old saying \"May you live in interesting times\"?  Sure seems like we're in pretty interesting times now, doesn't it?  Climate Change. Financial Crisis. Displaced Masses.<BR>  And the guys in charge?...yeah...let's not talk about the guys in charge.  But, if the movies have taught us anything about the complex nuances of geo-political hegemony <BR> coupled with unchecked anarcho-capitalism and the perils of a dyspeptic underclass (...and I think they <i>have</i>), it's that things could be worse...a LOT worse. <BR>  Therefore, to help take your mind off of all the bad-dude stuff in the world, this year your friends at Reclinathon are showcasing some of the very best examples of humanity at its very worst: Apocalypse films!  <BR> You think you've got problems?  Well, not nearly as bad as these people.  Because, sure, the stock market may be crashing...but at least it isn't crashing into a GIANT KILLER ASTEROID!!!!!  <BR> So, while it may very well be The End of the World (as we know it)...*I* feel fine...and after watching some of these movies, we hope you will, too!<BR><BR>";
