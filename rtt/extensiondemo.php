...
{
	echo "<next url='https://reclinathon.com' time='3000' />";
}
else if (strpos($sourceUrl, "netflix.com/watch/60031236") !== false)
{
	echo "<next url='https://hangouts.google.com/call/styow2upujcp3hvhninl64l5uee' time='60000' />";
}
else if (strpos($sourceUrl, "hangouts.google.com/call/styow2upujcp3hvhninl64l5uee") !== false)
{
	echo "<next url='https://www.netflix.com/watch/70083111?t=52' time='15000' />";
}
else if (strpos($sourceUrl, "netflix.com/watch/70083111") !== false)
{
	echo "<next url='https://www.reclinathon.com/rtt/feed_mockup.php' time='60000' />";
}
else
{
	echo "<next url='' time='0' />";
}
